...
module CabinetBuilder
  module CabinetMetadata
    ...
    module ClassMethods
      def read_params_from_group(group)
...

        {
          ...
          'front_handle_position' => group.get_attribute(CABINET_DICT, 'front_handle_position', 'dół'),
    ...
    def save_metadata
      ...
      @group.set_attribute(CABINET_DICT, 'front_handle_position', @front_handle_position)
