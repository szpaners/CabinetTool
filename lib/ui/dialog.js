...
function setFormData(params) {
    ...
    document.getElementById('front_handle_position').value = params.front_handle_position || 'dół';
    ...
    updateFrontHandlePositionOptions();
    ...
    const targetTab = params.cabinet_type === 'wardrobe' ? 'materials' : 'dimensions';
    const targetButton = Array.from(document.querySelectorAll('.tab')).find(tab => tab.getAttribute('onclick')?.includes(`'${targetTab}'`));
...
function saveCabinet() {
    ...
    const params = {
        ...
        front_handle_position: document.getElementById('front_handle_position').value,
...
function updateFrontHandlePositionOptions() {
    const handleInput = document.getElementById('front_handle');
    const positionInput = document.getElementById('front_handle_position');
...
document.getElementById('front_handle').addEventListener('change', updateFrontHandlePositionOptions);
