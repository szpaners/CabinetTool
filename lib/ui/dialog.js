...
function setFormData(params) {
    ...
    document.getElementById('corner_front_panel_width').value = params.corner_front_panel_width || 0;
...
function saveCabinet() {
    ...
    if (activeTab === 'corner') {
        ...
        const params = {
            ...
            connector_width: 0,
            corner_front_panel_width: document.getElementById('corner_front_panel_width').value,
