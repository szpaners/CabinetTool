(function() {
  ...
  const form = {
    ...
    blendLeftDepthCheckboxGroup: 'wardrobe_blend_left_depth_checkbox_group',
    blendLeftDepthCheckbox: 'wardrobe_blend_left_depth_checkbox',
    ...
    blendRightDepthCheckboxGroup: 'wardrobe_blend_right_depth_checkbox_group',
    blendRightDepthCheckbox: 'wardrobe_blend_right_depth_checkbox',
  ...
  function updateBlendVisibility() {
    const leftEnabled = byId(form.blendLeftCheckbox).checked;
    const rightEnabled = byId(form.blendRightCheckbox).checked;

    setVisible(form.blendLeftGroup, leftEnabled);
    setVisible(form.blendLeftDepthCheckboxGroup, leftEnabled);
    setVisible(form.blendLeftDepthGroup, leftEnabled && byId(form.blendLeftDepthCheckbox).checked);

    setVisible(form.blendRightGroup, rightEnabled);
    setVisible(form.blendRightDepthCheckboxGroup, rightEnabled);
    setVisible(form.blendRightDepthGroup, rightEnabled && byId(form.blendRightDepthCheckbox).checked);
  }
  ...
  function setFormData(params) {
    ...
    byId(form.blendLeftDepthCheckbox).checked = Number(params.blend_left_depth_value || 0) > 0;
    ...
    byId(form.blendRightDepthCheckbox).checked = Number(params.blend_right_depth_value || 0) > 0;
  ...
  function buildSaveParams() {
    ...
    const blendLeftDepthEnabled = byId(form.blendLeftDepthCheckbox).checked;
    const blendRightDepthEnabled = byId(form.blendRightDepthCheckbox).checked;
    ...
    return {
      ...
      blend_left_depth_value: blendLeftEnabled && blendLeftDepthEnabled ? byId(form.blendLeftDepthValue).value : 0,
      blend_right_depth_value: blendRightEnabled && blendRightDepthEnabled ? byId(form.blendRightDepthValue).value : 0,
  ...
  function bindEvents(updatePreview) {
    [
      ...
      form.blendLeftDepthCheckbox,
      form.blendRightCheckbox,
      form.blendRightDepthCheckbox,
      form.width,
      form.height,
      form.panelThickness,
